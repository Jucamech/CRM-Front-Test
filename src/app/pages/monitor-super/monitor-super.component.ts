...
@Component({
  selector: 'app-monitor-super',
  templateUrl: './monitor-super.component.html',
  styleUrls: ['./monitor-super.component.css']
})
export class MonitorSuperComponent implements OnInit, OnDestroy  {
  id: string;
  key_c: string;
  key_L: string;
  url: string;
