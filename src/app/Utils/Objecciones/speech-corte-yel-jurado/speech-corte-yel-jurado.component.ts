...
@Component({
  selector: 'app-speech-corte-yel-jurado',
  templateUrl: './speech-corte-yel-jurado.component.html',
  styleUrls: ['./speech-corte-yel-jurado.component.css']
})
export class SpeechCorteYelJuradoComponent implements OnInit, OnDestroy {
  susb: Subscription;
