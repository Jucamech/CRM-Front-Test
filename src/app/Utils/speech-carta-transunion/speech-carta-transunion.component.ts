...
@Component({
  selector: 'app-speech-carta-transunion',
  templateUrl: './speech-carta-transunion.component.html',
  styleUrls: ['./speech-carta-transunion.component.css']
})
export class SpeechCartaTransunionComponent implements OnInit {
  susb: any;
  nombre: string;
